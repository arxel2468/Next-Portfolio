...
export default function Work() {
  ...
  return (
    <section id="work" className="py-24 bg-gradient-to-br from-blue-100 via-cyan-50 to-indigo-100 dark:from-gray-900 dark:via-blue-950 dark:to-indigo-950 text-gray-900 dark:text-gray-100">
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-lg text-gray-700 dark:text-gray-400">
          ...
          <div className="p-6 md:p-10">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              ...
              >
                <div className="flex items-center mb-6">
                  <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="p-4 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/30 rounded-2xl mr-5 shadow-sm border border-blue-200/50 dark:border-blue-700/30"
                  >
                    <Image
                      src={ShopifyStore}
                      alt="Shopify Logo"
                  ...
                  {[
                    ...
                    >
                      <motion.div 
                        ...
                        className={`flex-shrink-0 mt-1 p-2 ${item.color} rounded-lg shadow-sm border group-hover:border-blue-300 dark:group-hover:border-blue-500 transition-all duration-300`}
                      >
                        {item.icon}
                      </motion.div>
                      <div className="ml-4">
                ...
                >
                  {[
                    ...
                    { text: "E-commerce", color: "bg-indigo-100 text-indigo-800 border-indigo-200 dark:bg-indigo-900/40 dark:text-indigo-300 dark:border-indigo-800/50" },
                    { text: "Meta Ads", color: "bg-cyan-100 text-cyan-800 border-cyan-200 dark:bg-cyan-900/40 dark:text-cyan-300 dark:border-cyan-800/50" },
                    { text: "Marketing", color: "bg-sky-100 text-sky-800 border-sky-200 dark:bg-sky-900/40 dark:text-sky-300 dark:border-sky-800/50" },
                    { text: "Analytics", color: "bg-teal-100 text-teal-800 border-teal-200 dark:bg-teal-900/40 dark:text-teal-300 dark:border-teal-800/50" }
                  ].map((tag, index) => (
                    <motion.span 
                      key={index}
                ...
                >
                  <motion.a 
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 focus:ring-4 focus:ring-blue-300/50 dark:focus:ring-blue-800/50 transition-all shadow-md"
                  >
                    Visit StealStreet
                    <motion.svg 
              ...
              <motion.div 
                ...
                transition={{ duration: 0.5, delay: 0.3 }}
                viewport={{ once: true }}
                className="w-full md:w-1/3 bg-gradient-to-br from-blue-600 via-indigo-600 to-cyan-600 rounded-xl p-7 text-white shadow-lg border border-blue-400/20"
              >
                <motion.div 
                      ...
                      <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                        <motion.div 
                          ...
                          className={`h-2 rounded-full ${
                            activeMetric === index 
                              ? 'bg-white' 
                              : 'bg-gradient-to-r from-blue-300 via-indigo-300 to-cyan-300'
                          }`}
                        ></motion.div>
                      </div>
                    </motion.div>
